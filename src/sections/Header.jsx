...
const NavLink = ({ title }) => <LinkScroll className="base-bold text-p4 uppercase transition-colors duration-500 cursor-pointer hover:text-p1 max-lg:my-4 max-lg:h5">{title}</LinkScroll>;
   ...
   return (
      <header className="fixed top-0 left-0 z-50 w-full py-10">
         <div className="container flex h-14 items-center max-lg:px-5">
            ...
            <div className={clsx("w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:bg-s2 max-lg:opacity-0 max-lg:w-full", isOpen ? "max-lg:opacity-100" : "pointer-events-none")}>
