      ...
      <section>
         <Element name="pricing">
            <div className="container">
               <div className="max-w-960 pricing-head_befor relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
                  <h3 className="h3 max-lg:h4 max-md:h5 z-3 relative mx-auto mb-14 max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm">Flexible pricing for teams all sizes</h3>
               ...
               <div className="scroll-hide relative z-2 -mt-12 flex items-start max-lg:gap-5 max-xl:overflow-auto max-xl:pt-6">
                  {plans.map((plan, index) => (
                     ...
                     >
                        {index === 1 && <div className="g4 absolute h-330 left-0 top-0 rounded-tl-3xl rounded-tr-3xl" />}
